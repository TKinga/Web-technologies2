  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <div className="flex justify-between align-middle">
        <h2 className="mb-6 text-3xl font-semibold text-barbiePink dark:text-white">
          Termékek
        </h2>
        <Link to="/create" className="hover:text-barbiePink mb-6 font-bold" title='Létrehozás'>
          <svg
      ...
      <div className="max-w-full overflow-x-auto">
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-barbiePink text-left dark:bg-barbiePink">
                ...
                >
                  ...
                  <td className="py-5 px-4">
                    <div className="flex items-center space-x-3.5">
                      <Link
                        to={`/edit/${product._id}`}
                        className="hover:text-barbiePink"
                        title='Szerkesztés'
                      >
                        <svg
