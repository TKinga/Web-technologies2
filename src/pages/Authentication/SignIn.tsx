            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <h2 className="mb-9 text-2xl font-bold text-white dark:text-white sm:text-title-xl2">
                ...
                <div className="mb-5">
                  <button
                    onClick={handleLogin}
                    className="w-full cursor-pointer text-xl font-bold rounded-lg border border-white bg-white p-4 text-gifPink transition hover:bg-opacity-90 dark:bg-strokedark dark:border-strokedark"
                  >
                    Bejelentkezés
                  </button>
                </div>
