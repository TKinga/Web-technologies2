  ...
  return (
    <DefaultLayout>
      <div className="rounded-lg border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="rounded-lg flex flex-wrap items-center bg-gifPink">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <span className="inline-block">
                <img src="/src/images/gif/barbie-world.gif" alt="gif" className='h-80' />
              </span>
            </div>
          </div>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div className="mb-5">
                <button className="w-full cursor-pointer text-xl font-bold  rounded-lg border border-white bg-white p-4 text-gifPink transition hover:bg-opacity-90 dark:bg-strokedark dark:border-strokedark"
